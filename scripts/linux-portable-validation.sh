...
cargo clippy -p signtool-sip-digest -p signtool-digest-cli -p signtool-authenticode-trust \
  -p signtool-codesigning-rest -p signtool-azure-kv-rest \
...
cargo clippy -p signtool-digest-cli --all-targets --features azure-kv-sign-portable --locked -- -D warnings
...
cargo test -p signtool-azure-kv-rest --lib --locked
...
echo "== integration: signtool-portable (azure-kv-sign-portable) =="
cargo test -p signtool-digest-cli --features azure-kv-sign-portable --locked
