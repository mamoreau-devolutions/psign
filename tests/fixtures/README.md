...
The committed generated corpus is split into:

- `tests/fixtures/generated-unsigned/` plus `generated-unsigned.zip` — unsigned
  source vectors and `generated-vectors.json`.
- `tests/fixtures/generated-signed/` plus `generated-signed.zip` — SignTool-signed
  counterparts where native signing succeeds, plus
  `generated-signed-vectors.json`.
