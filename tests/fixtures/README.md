...
Generated unsigned vectors should be written under
`tests/fixtures/generated-unsigned/` (gitignored). If a small archive is useful
for repeatable local runs, generate `tests/fixtures/generated-unsigned.zip` and
review the manifest hashes before committing it.
